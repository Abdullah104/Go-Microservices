...
const file_currency_proto_rawDesc = "" +
	...
	"\x04Rate\x18\x01 \x01(\x01R\x04Rate*\xac\x02\n" +
	"\n" +
	"Currencies\x12\a\n" +
	...
	"\x03INR\x10\x17\x12\a\n" +
	"\x03KRW\x10\x18\x12\a\n" +
	"\x03MXN\x10\x19\x12\a\n" +
	"\x03MYR\x10\x1a\x12\a\n" +
	"\x03NZD\x10\x1b\x12\a\n" +
	"\x03PHP\x10\x1c\x12\a\n" +
	"\x03SGD\x10\x1d\x12\a\n" +
	"\x03THB\x10\x1e\x12\a\n" +
	"\x03ZAR\x10\x1f22\n" +
	"\bCurrency\x12&\n" +
	"\aGetRate\x12\f.RateRequest\x1a\r.RateResponseB\fZ\n" +
	".;currencyb\x06proto3"
