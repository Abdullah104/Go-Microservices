...
// which works with the local disk on the current machine.
type Local struct {
...
// Save the content of the Writer to the given path
// path is a relative path, basePath will be appendid
